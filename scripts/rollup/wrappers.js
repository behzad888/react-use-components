...
const RC_WWW_DEV = Bundles.bundleTypes.RC_WWW_DEV;
const RC_WWW_PROD = Bundles.bundleTypes.RC_WWW_PROD;
const RC_WWW_PROFILING = Bundles.bundleTypes.RC_WWW_PROFILING;
...
const RN_RC_DEV = Bundles.bundleTypes.RN_RC_DEV;
const RN_RC_PROD = Bundles.bundleTypes.RN_RC_PROD;
const RN_RC_PROFILING = Bundles.bundleTypes.RN_RC_PROFILING;
...
${source}`;
  ...
  /****************** RC_WWW_DEV ******************/
  [RC_WWW_DEV](source, globalName, filename, moduleType) {
    return `/**
${license}
 *
 * @noflow
...
${source}
  ...
  /****************** RC_WWW_PROD ******************/
  [RC_WWW_PROD](source, globalName, filename, moduleType) {
    return `/**
${license}
 *
 * @noflow
...
${source}`;
  ...
  /****************** RC_WWW_PROFILING ******************/
  [RC_WWW_PROFILING](source, globalName, filename, moduleType) {
    return `/**
${license}
 *
 * @noflow
...
${source}`;
  ...
  /****************** RN_RC_DEV ******************/
  [RN_RC_DEV](source, globalName, filename, moduleType) {
    return `/**
${license}
 *
 * @noflow
...
${source}
  ...
  /****************** RN_RC_PROD ******************/
  [RN_RC_PROD](source, globalName, filename, moduleType) {
    return `/**
${license}
 *
 * @noflow
...
${source}`;
  ...
  /****************** RN_RC_PROFILING ******************/
  [RN_RC_PROFILING](source, globalName, filename, moduleType) {
    return `/**
${license}
 *
 * @noflow
