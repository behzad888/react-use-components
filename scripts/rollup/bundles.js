...
const bundles = [
  ...
  /******* Test Utils *******/
  {
    ...
    bundleTypes: [RC_WWW_DEV, NODE_DEV, NODE_PROD, UMD_DEV, UMD_PROD],
  ...
  {
    bundleTypes: [NODE_DEV, NODE_PROD, RC_WWW_DEV, RC_WWW_PROD],
    moduleType: RENDERER,
  ...
  /******* React Native *******/
  {
    bundleTypes: [RN_RC_DEV, RN_RC_PROD, RN_RC_PROFILING],
    moduleType: RENDERER,
  ...
  /******* ESLint Plugin for Hooks (proposal) *******/
  {
    ...
    bundleTypes: [NODE_DEV, NODE_PROD, RC_WWW_DEV],
    moduleType: ISOMORPHIC,
